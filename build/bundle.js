...
var app = (function () {
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "answer svelte-1xw7xer");
    			add_location(p, file, 172, 2, 3870);
    		},
    ...
    // (152:1) {#if closeDamage && farDamage && closeRange && farRange && multiplier && damageToFind}
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(152:1) {#if closeDamage && farDamage && closeRange && farRange && multiplier && damageToFind}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t0 = text("Deals ");
    			t1 = text(/*damageToFind*/ ctx[5]);
    			t2 = text(" damage up to ");
    			t3 = text(/*final*/ ctx[7]);
    			t4 = text(" studs");
    			attr_dev(p, "class", "answer svelte-1xw7xer");
    			add_location(p, file, 167, 5, 3762);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*damageToFind*/ 32) set_data_dev(t1, /*damageToFind*/ ctx[5]);
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "answer svelte-1xw7xer");
    			add_location(p, file, 165, 5, 3684);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    ...
    // (163:4) {#if farDamage > closeDamage }
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(" studs");
    			attr_dev(p, "class", "answer svelte-1xw7xer");
    			add_location(p, file, 163, 5, 3569);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(163:4) {#if farDamage > closeDamage }",
    		ctx
    	});
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(" damage all ranges");
    			attr_dev(p, "class", "answer svelte-1xw7xer");
    			add_location(p, file, 160, 4, 3455);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    ...
    // (158:3) {#if opt < closeRange && opt < farRange }
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = text(";");
    			attr_dev(p, "class", "answer svelte-1xw7xer");
    			add_location(p, file, 158, 4, 3344);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(158:3) {#if opt < closeRange && opt < farRange }",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(" damage all ranges");
    			attr_dev(p, "class", "answer svelte-1xw7xer");
    			add_location(p, file, 155, 3, 3223);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    ...
    // (153:2) {#if (closeDamage * multiplier) < damageToFind && (farDamage * multiplier) < damageToFind }
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(" damage");
    			attr_dev(p, "class", "answer svelte-1xw7xer");
    			add_location(p, file, 153, 3, 3062);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(153:2) {#if (closeDamage * multiplier) < damageToFind && (farDamage * multiplier) < damageToFind }",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div8 = element("div");
    			p7 = element("p");
    			t27 = text("Version 2.0.0. Last updated 11th January 2022.");
    			br5 = element("br");
    			...
    			add_location(br0, file, 118, 96, 2030);
    			add_location(br1, file, 119, 49, 2084);
    			attr_dev(p0, "class", "svelte-1xw7xer");
    			add_location(p0, file, 117, 0, 1930);
    			add_location(br2, file, 122, 0, 2095);
    			attr_dev(p1, "class", "label svelte-1xw7xer");
    			add_location(p1, file, 126, 3, 2166);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "class", "svelte-1xw7xer");
    			add_location(input0, file, 127, 3, 2210);
    			attr_dev(div0, "class", "value svelte-1xw7xer");
    			add_location(div0, file, 125, 2, 2143);
    			attr_dev(p2, "class", "label svelte-1xw7xer");
    			add_location(p2, file, 130, 3, 2289);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "class", "svelte-1xw7xer");
    			add_location(input1, file, 131, 3, 2332);
    			attr_dev(div1, "class", "value svelte-1xw7xer");
    			add_location(div1, file, 129, 2, 2266);
    			attr_dev(p3, "class", "label svelte-1xw7xer");
    			add_location(p3, file, 134, 3, 2409);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "class", "svelte-1xw7xer");
    			add_location(input2, file, 135, 3, 2453);
    			attr_dev(div2, "class", "value svelte-1xw7xer");
    			add_location(div2, file, 133, 2, 2386);
    			attr_dev(p4, "class", "label svelte-1xw7xer");
    			add_location(p4, file, 138, 3, 2531);
    			attr_dev(input3, "type", "number");
    			attr_dev(input3, "class", "svelte-1xw7xer");
    			add_location(input3, file, 139, 3, 2576);
    			attr_dev(div3, "class", "value svelte-1xw7xer");
    			add_location(div3, file, 137, 2, 2508);
    			attr_dev(p5, "class", "label svelte-1xw7xer");
    			add_location(p5, file, 142, 3, 2652);
    			attr_dev(input4, "type", "number");
    			attr_dev(input4, "class", "svelte-1xw7xer");
    			add_location(input4, file, 143, 3, 2695);
    			attr_dev(div4, "class", "value svelte-1xw7xer");
    			add_location(div4, file, 141, 2, 2629);
    			attr_dev(p6, "class", "label svelte-1xw7xer");
    			add_location(p6, file, 146, 3, 2773);
    			attr_dev(input5, "type", "number");
    			attr_dev(input5, "class", "svelte-1xw7xer");
    			add_location(input5, file, 147, 3, 2813);
    			attr_dev(div5, "class", "value svelte-1xw7xer");
    			add_location(div5, file, 145, 2, 2750);
    			attr_dev(div6, "class", "values svelte-1xw7xer");
    			add_location(div6, file, 124, 1, 2120);
    			attr_dev(div7, "class", "main svelte-1xw7xer");
    			add_location(div7, file, 123, 0, 2100);
    			add_location(br3, file, 176, 0, 3934);
    			add_location(br4, file, 179, 1, 3950);
    			add_location(br5, file, 182, 48, 4031);
    			...
    			add_location(div8, file, 180, 1, 3956);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*opt*/ 64) {
    			$$invalidate(7, final = opt.toFixed(2));
    		}
    	};
