...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			br2 = element("br");
    			attr_dev(h1, "class", "svelte-1q5fixp");
    			add_location(h1, file$4, 135, 1, 2252);
    			add_location(br0, file$4, 137, 1, 2281);
    			add_location(br1, file$4, 138, 24, 2311);
    			add_location(br2, file$4, 139, 132, 2449);
    			attr_dev(p, "class", "svelte-1q5fixp");
    			add_location(p, file$4, 136, 1, 2275);
    			attr_dev(div, "class", "main svelte-1q5fixp");
    			add_location(div, file$4, 134, 0, 2231);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			br43 = element("br");
    			attr_dev(h1, "class", "svelte-1q5fixp");
    			add_location(h1, file$3, 135, 1, 2252);
    			add_location(br0, file$3, 136, 1, 2272);
    			add_location(br1, file$3, 138, 88, 2372);
    			attr_dev(p0, "class", "svelte-1q5fixp");
    			add_location(p0, file$3, 137, 1, 2279);
    			add_location(br2, file$3, 140, 1, 2386);
    			add_location(br3, file$3, 141, 1, 2393);
    			attr_dev(h30, "class", "svelte-1q5fixp");
    			add_location(h30, file$3, 144, 3, 2452);
    			add_location(br4, file$3, 147, 162, 2644);
    			add_location(br5, file$3, 148, 3, 2653);
    			attr_dev(a0, "class", "realLink svelte-1q5fixp");
    			attr_dev(a0, "href", "https://Scaledrone.com/");
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "rel", "noopener noreferrer");
    			add_location(a0, file$3, 149, 18, 2677);
    			add_location(br6, file$3, 149, 172, 2831);
    			add_location(br7, file$3, 150, 3, 2840);
    			add_location(br8, file$3, 151, 171, 3017);
    			attr_dev(a1, "class", "realLink svelte-1q5fixp");
    			attr_dev(a1, "href", "https://docsocial.tk/");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "rel", "noopener noreferrer");
    			add_location(a1, file$3, 152, 3, 3026);
    			add_location(br9, file$3, 152, 110, 3133);
    			attr_dev(a2, "class", "realLink svelte-1q5fixp");
    			attr_dev(a2, "href", "https://docsocial.cf/");
    			attr_dev(a2, "target", "_blank");
    			attr_dev(a2, "rel", "noopener noreferrer");
    			add_location(a2, file$3, 153, 3, 3142);
    			add_location(br10, file$3, 153, 110, 3249);
    			add_location(br11, file$3, 154, 3, 3258);
    			...
    			add_location(img0, file$3, 157, 3, 3271);
    			attr_dev(p1, "class", "svelte-1q5fixp");
    			add_location(p1, file$3, 146, 3, 2477);
    			attr_dev(div0, "class", "project svelte-1q5fixp");
    			add_location(div0, file$3, 143, 2, 2426);
    			attr_dev(h31, "class", "svelte-1q5fixp");
    			add_location(h31, file$3, 163, 3, 3393);
    			add_location(br12, file$3, 166, 54, 3476);
    			add_location(br13, file$3, 167, 109, 3591);
    			add_location(br14, file$3, 168, 3, 3600);
    			attr_dev(a3, "class", "realLink svelte-1q5fixp");
    			attr_dev(a3, "href", "https://taski.ml/");
    			attr_dev(a3, "target", "_blank");
    			attr_dev(a3, "rel", "noopener noreferrer");
    			add_location(a3, file$3, 169, 130, 3736);
    			add_location(br15, file$3, 169, 230, 3836);
    			add_location(br16, file$3, 170, 219, 4061);
    			add_location(br17, file$3, 171, 136, 4203);
    			add_location(br18, file$3, 172, 3, 4212);
    			add_location(br19, file$3, 173, 161, 4379);
    			attr_dev(a4, "class", "realLink svelte-1q5fixp");
    			attr_dev(a4, "href", "https://github.com/HelioDex/HybridOS/");
    			attr_dev(a4, "target", "_blank");
    			attr_dev(a4, "rel", "noopener noreferrer");
    			add_location(a4, file$3, 174, 3, 4388);
    			add_location(br20, file$3, 175, 3, 4532);
    			attr_dev(a5, "class", "realLink svelte-1q5fixp");
    			attr_dev(a5, "href", "https://www.youtube.com/watch?v=QwhaqpOL310/");
    			attr_dev(a5, "target", "_blank");
    			attr_dev(a5, "rel", "noopener noreferrer");
    			add_location(a5, file$3, 176, 3, 4541);
    			add_location(br21, file$3, 176, 164, 4702);
    			add_location(br22, file$3, 177, 3, 4711);
    			...
    			add_location(img1, file$3, 178, 4, 4721);
    			attr_dev(p2, "class", "svelte-1q5fixp");
    			add_location(p2, file$3, 165, 3, 3417);
    			attr_dev(div1, "class", "project svelte-1q5fixp");
    			add_location(div1, file$3, 161, 2, 3362);
    			attr_dev(h32, "class", "svelte-1q5fixp");
    			add_location(h32, file$3, 185, 3, 4880);
    			add_location(br23, file$3, 188, 146, 5066);
    			add_location(br24, file$3, 189, 129, 5201);
    			add_location(br25, file$3, 190, 3, 5210);
    			add_location(br26, file$3, 191, 124, 5340);
    			add_location(br27, file$3, 192, 74, 5420);
    			attr_dev(a6, "class", "realLink svelte-1q5fixp");
    			attr_dev(a6, "href", "https://pfcalc.heliodex.cf/");
    			attr_dev(a6, "target", "_blank");
    			attr_dev(a6, "rel", "noopener noreferrer");
    			add_location(a6, file$3, 193, 34, 5460);
    			add_location(br28, file$3, 193, 155, 5581);
    			attr_dev(a7, "class", "realLink svelte-1q5fixp");
    			attr_dev(a7, "href", "https://oldpfcalc.heliodex.cf/");
    			attr_dev(a7, "target", "_blank");
    			attr_dev(a7, "rel", "noopener noreferrer");
    			add_location(a7, file$3, 194, 36, 5623);
    			add_location(br29, file$3, 194, 163, 5750);
    			add_location(br30, file$3, 195, 3, 5759);
    			...
    			add_location(img2, file$3, 197, 3, 5770);
    			attr_dev(p3, "class", "svelte-1q5fixp");
    			add_location(p3, file$3, 187, 3, 4915);
    			attr_dev(div2, "class", "project svelte-1q5fixp");
    			add_location(div2, file$3, 184, 2, 4853);
    			attr_dev(h33, "class", "svelte-1q5fixp");
    			add_location(h33, file$3, 204, 3, 5910);
    			add_location(br31, file$3, 207, 126, 6075);
    			add_location(br32, file$3, 208, 134, 6215);
    			add_location(br33, file$3, 209, 81, 6302);
    			add_location(br34, file$3, 210, 3, 6311);
    			attr_dev(a8, "class", "realLink svelte-1q5fixp");
    			attr_dev(a8, "href", "https://www.tomscott.com/usvsth3m/maths/");
    			attr_dev(a8, "target", "_blank");
    			attr_dev(a8, "rel", "noopener noreferrer");
    			add_location(a8, file$3, 211, 63, 6380);
    			add_location(br35, file$3, 211, 230, 6547);
    			add_location(br36, file$3, 212, 3, 6556);
    			attr_dev(a9, "class", "realLink svelte-1q5fixp");
    			attr_dev(a9, "href", "https://www.roblox.com/games/7557207546/");
    			attr_dev(a9, "target", "_blank");
    			attr_dev(a9, "rel", "noopener noreferrer");
    			add_location(a9, file$3, 213, 37, 6599);
    			add_location(br37, file$3, 213, 180, 6742);
    			add_location(br38, file$3, 214, 3, 6751);
    			...
    			add_location(img3, file$3, 216, 3, 6762);
    			attr_dev(p4, "class", "svelte-1q5fixp");
    			add_location(p4, file$3, 206, 3, 5944);
    			attr_dev(div3, "class", "project svelte-1q5fixp");
    			add_location(div3, file$3, 202, 2, 5879);
    			attr_dev(h34, "class", "svelte-1q5fixp");
    			add_location(h34, file$3, 222, 3, 6891);
    			add_location(br39, file$3, 225, 114, 7054);
    			add_location(br40, file$3, 226, 130, 7190);
    			add_location(br41, file$3, 227, 3, 7199);
    			add_location(em, file$3, 228, 82, 7287);
    			add_location(br42, file$3, 228, 199, 7404);
    			attr_dev(a10, "class", "realLink svelte-1q5fixp");
    			attr_dev(a10, "href", "https://github.com/Heliodex/PythonCalculators/");
    			attr_dev(a10, "target", "_blank");
    			attr_dev(a10, "rel", "noopener noreferrer");
    			add_location(a10, file$3, 229, 25, 7435);
    			add_location(br43, file$3, 229, 184, 7594);
    			attr_dev(p5, "class", "svelte-1q5fixp");
    			add_location(p5, file$3, 224, 3, 6935);
    			attr_dev(div4, "class", "project svelte-1q5fixp");
    			add_location(div4, file$3, 221, 2, 6865);
    			attr_dev(div5, "class", "projects svelte-1q5fixp");
    			add_location(div5, file$3, 142, 1, 2400);
    			attr_dev(div6, "class", "main svelte-1q5fixp");
    			add_location(div6, file$3, 134, 0, 2231);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t12 = text("\r\n\ttodo: about page");
    			attr_dev(h1, "class", "svelte-1q5fixp");
    			add_location(h1, file$2, 135, 1, 2252);
    			add_location(br0, file$2, 136, 1, 2269);
    			attr_dev(p0, "class", "svelte-1q5fixp");
    			add_location(p0, file$2, 138, 1, 2278);
    			add_location(br1, file$2, 138, 16, 2293);
    			attr_dev(p1, "class", "svelte-1q5fixp");
    			add_location(p1, file$2, 139, 1, 2300);
    			attr_dev(p2, "class", "ipa svelte-1q5fixp");
    			add_location(p2, file$2, 139, 15, 2314);
    			attr_dev(p3, "class", "svelte-1q5fixp");
    			add_location(p3, file$2, 139, 35, 2334);
    			attr_dev(p4, "class", "ipa svelte-1q5fixp");
    			add_location(p4, file$2, 139, 43, 2342);
    			attr_dev(p5, "class", "svelte-1q5fixp");
    			add_location(p5, file$2, 139, 63, 2362);
    			add_location(br2, file$2, 139, 73, 2372);
    			add_location(br3, file$2, 143, 13, 2515);
    			attr_dev(p6, "class", "svelte-1q5fixp");
    			add_location(p6, file$2, 142, 1, 2497);
    			attr_dev(div, "class", "main svelte-1q5fixp");
    			add_location(div, file$2, 134, 0, 2231);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			br11 = element("br");
    			attr_dev(h1, "class", "svelte-1q5fixp");
    			add_location(h1, file$1, 135, 1, 2252);
    			add_location(br0, file$1, 136, 1, 2271);
    			add_location(br1, file$1, 139, 82, 2368);
    			add_location(br2, file$1, 139, 86, 2372);
    			attr_dev(a0, "class", "realLink svelte-1q5fixp");
    			attr_dev(a0, "href", "https://github.com/Heliodex/");
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "rel", "noopener noreferrer");
    			add_location(a0, file$1, 140, 20, 2398);
    			add_location(br3, file$1, 140, 141, 2519);
    			attr_dev(a1, "class", "realLink svelte-1q5fixp");
    			attr_dev(a1, "href", "https://twitter.com/lwinklly/");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "rel", "noopener noreferrer");
    			add_location(a1, file$1, 141, 21, 2546);
    			add_location(br4, file$1, 141, 144, 2669);
    			attr_dev(a2, "class", "realLink svelte-1q5fixp");
    			attr_dev(a2, "href", "https://www.reddit.com/user/Heliodex/");
    			attr_dev(a2, "target", "_blank");
    			attr_dev(a2, "rel", "noopener noreferrer");
    			add_location(a2, file$1, 142, 21, 2696);
    			add_location(br5, file$1, 142, 153, 2828);
    			attr_dev(a3, "class", "realLink svelte-1q5fixp");
    			attr_dev(a3, "href", "https://devforum.roblox.com/u/lewin4/summary/");
    			attr_dev(a3, "target", "_blank");
    			attr_dev(a3, "rel", "noopener noreferrer");
    			add_location(a3, file$1, 143, 26, 2860);
    			add_location(br6, file$1, 143, 173, 3007);
    			attr_dev(a4, "class", "realLink svelte-1q5fixp");
    			attr_dev(a4, "href", "https://www.roblox.com/users/77663253/profile/");
    			attr_dev(a4, "target", "_blank");
    			attr_dev(a4, "rel", "noopener noreferrer");
    			add_location(a4, file$1, 144, 18, 3031);
    			add_location(br7, file$1, 144, 171, 3184);
    			attr_dev(a5, "class", "realLink svelte-1q5fixp");
    			attr_dev(a5, "href", "https://www.youtube.com/channel/UC8E2hw963cW5IJXZnBE6_vg/");
    			attr_dev(a5, "target", "_blank");
    			attr_dev(a5, "rel", "noopener noreferrer");
    			add_location(a5, file$1, 145, 21, 3211);
    			add_location(br8, file$1, 145, 196, 3386);
    			attr_dev(a6, "class", "realLink svelte-1q5fixp");
    			attr_dev(a6, "href", "https://discord.com/users/290622468547411968");
    			attr_dev(a6, "target", "_blank");
    			attr_dev(a6, "rel", "noopener noreferrer");
    			add_location(a6, file$1, 146, 25, 3417);
    			add_location(br9, file$1, 146, 179, 3571);
    			add_location(br10, file$1, 147, 20, 3597);
    			attr_dev(a7, "class", "realLink svelte-1q5fixp");
    			attr_dev(a7, "href", "mailto:Heli@odex.cf");
    			attr_dev(a7, "target", "_blank");
    			attr_dev(a7, "rel", "noopener noreferrer");
    			add_location(a7, file$1, 148, 22, 3625);
    			add_location(br11, file$1, 148, 127, 3730);
    			attr_dev(p, "class", "svelte-1q5fixp");
    			add_location(p, file$1, 138, 1, 2281);
    			attr_dev(div, "class", "main svelte-1q5fixp");
    			add_location(div, file$1, 134, 0, 2231);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 159, 2, 3088);
    			attr_dev(button0, "class", "sideButton svelte-1q5fixp");
    			add_location(button0, file, 161, 2, 3162);
    			attr_dev(button1, "class", "sideButton svelte-1q5fixp");
    			add_location(button1, file, 162, 2, 3240);
    			attr_dev(button2, "class", "sideButton svelte-1q5fixp");
    			add_location(button2, file, 163, 2, 3326);
    			attr_dev(button3, "class", "sideButton svelte-1q5fixp");
    			add_location(button3, file, 164, 2, 3406);
    			attr_dev(p, "class", "version svelte-1q5fixp");
    			add_location(p, file, 166, 2, 3492);
    			attr_dev(div, "class", "sidenav svelte-1q5fixp");
    			add_location(div, file, 156, 1, 3004);
    			attr_dev(body, "class", "svelte-1q5fixp");
    			add_location(body, file, 155, 0, 2995);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function changePage(whichPage) {
    		$$invalidate(0, Page = whichPage); // If done in the same line, the svelte:component will not react
